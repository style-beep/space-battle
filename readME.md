...
|------------|------------|
| 🎨 **HTML5 Canvas** | Рендеринг графики, частиц, эффектов |
| 💎 **CSS3** | Glassmorphism, неоновые эффекты, адаптив |
| ⚡ **JavaScript (ES6+)** | Игровой движок, физика столкновений |
| 🔤 **Google Fonts** | Шрифт Orbitron для футуристического стиля |
...
### 🎯 Очки
- ➕ **+10 очков** за каждого врага
- 📈 **Множитель сложности:** x0.8 (Лёгко) → x1.5 (Безумие)
- 🏆 Чем выше сложность — тем больше очков

### 💚 Жизни
- 💥 При столкновении с врагом теряется **1 жизнь**
- ✨ После попадания — **0.75 секунды неуязвимости**
- ⚰️ При потере всех жизней игра заканчивается (кроме бесконечного режима)

### 📊 Сложность
| Параметр | Легко | Нормаль | Сложно | Безумие |
|----------|-------|---------|--------|---------|
| ❤️ Жизни | 8 | 6 | 4 | 3 |
| 🐌 Скорость врагов | 45% | 70% | 95% | 130% |
| 📦 Макс. врагов | 2 | 2 | 3 | 4 |

### 📈 Нарастание сложности
- 🎯 **Каждые 400 очков** — враги появляются чаще
- 🚀 **Максимальная частота** ограничена настройками сложности
- ♾️ **В бесконечном режиме** сложность растёт бесконечно
